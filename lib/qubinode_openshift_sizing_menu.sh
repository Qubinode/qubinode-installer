...
EOH
    ...
    show_menus_ocp4 () {
        ...
        printf "%s\n" "    ${cyn}OpenShift Storage Cluster Deployment Options${end}"
        printf "%s\n" "    These options require a minimum of 128 Gib memory and 8 cores."
        printf "%s\n" "    This will deploy the default configuration of 3 ctrlplane and 3 computes"
        ...
        printf "%s\n" "      5. 6 node cluster with OpenShift Container Storage"
        printf "%s\n" "      6. Custom Deployment"
        printf "%s\n" "      7. Reset to defaults"
